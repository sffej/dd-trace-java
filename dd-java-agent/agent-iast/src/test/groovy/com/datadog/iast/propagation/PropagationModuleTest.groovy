...
class PropagationModuleTest extends IastModuleImplTestBase {
  ...
  void 'test taint'() {
    ...
    when:
    module.taintObject(ctx, target, source.origin, source.name, source.value)
  ...
  void 'test taint with range'() {
    ...
    when:
    module.taintObjectRange(ctx, target, source.origin, start, length)
  ...
  void 'test taintIfTainted keeping ranges'() {
    ...
    module.taintObjectIfTainted(ctx, target, input, true, NOT_MARKED)
  ...
  void 'test taintIfTainted keeping ranges with a mark'() {
    ...
    when: 'input is not tainted'
    module.taintObjectIfTainted(ctx, target, input, true, mark)
  ...
  void 'test taintIfTainted not keeping ranges with a mark'() {
    ...
    when: 'input is not tainted'
    module.taintObjectIfTainted(ctx, target, input, false, mark)
  ...
  void 'test taintIfAnyTainted keeping ranges'() {
    ...
    when: 'input is not tainted'
    module.taintObjectIfAnyTainted(ctx, target, inputs, true, NOT_MARKED)
  ...
  void 'test taintIfAnyTainted keeping ranges with a mark'() {
    ...
    when: 'input is not tainted'
    module.taintObjectIfAnyTainted(ctx, target, inputs, true, mark)
  ...
  void 'test taintIfAnyTainted not keeping ranges with a mark'() {
    ...
    when: 'input is not tainted'
    module.taintObjectIfAnyTainted(ctx, target, inputs, false, mark)
  ...
  void 'test source names over threshold'() {
    ...
    when:
    module.taintObject(ctx, target, SourceTypes.REQUEST_PARAMETER_VALUE)
  ...
  void 'test that source names/values should not make a strong reference over the value'() {
    when:
    module.taintObject(ctx, toTaint, SourceTypes.REQUEST_PARAMETER_NAME, name, value)
  ...
  void 'test propagation of the source value for non char sequences'() {
    ...
    module.taintObject(ctx, baos, SourceTypes.KAFKA_MESSAGE_KEY)
    ...
    module.taintStringIfTainted(ctx, toTaint, baos)
