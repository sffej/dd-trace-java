  ...
  public static String afterEncodeForHTML(
    ...
    if (result != null && module != null) {
      try {
        ...
        if (ctx != null) {
          module.taintStringIfTainted(ctx, result, input, false, VulnerabilityMarks.XSS_MARK);
        }
      ...
      try {
        ...
        if (ctx != null) {
          module.taintStringIfTainted(
              ctx, result, input, false, VulnerabilityMarks.LDAP_INJECTION_MARK);
        }
      } catch (final Throwable e) {
  ...
  public static String afterEncodeForSQL(
    ...
    if (result != null && module != null) {
      try {
        ...
        if (ctx != null) {
          module.taintStringIfTainted(
              ctx, result, input, false, VulnerabilityMarks.SQL_INJECTION_MARK);
        }
      } catch (final Throwable e) {
