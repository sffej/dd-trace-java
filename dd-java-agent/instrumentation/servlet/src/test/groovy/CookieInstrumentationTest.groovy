...
class CookieInstrumentationTest extends AgentTestRunner {
  ...
  void 'test getName'() {
    ...
    then:
    result == NAME
    1 * iastModule.taintObjectIfTainted(iastCtx, NAME, cookie, SourceTypes.REQUEST_COOKIE_NAME, NAME)
  }
  ...
  void 'test getValue'() {
    ...
    then:
    result == VALUE
    1 * iastModule.taintObjectIfTainted(iastCtx, VALUE, cookie, SourceTypes.REQUEST_COOKIE_VALUE, NAME)
  }
