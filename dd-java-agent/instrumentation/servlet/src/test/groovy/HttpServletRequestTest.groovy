...
class HttpServletRequestTest extends AgentTestRunner {
  ...
  void 'test getHeader'() {
    ...
    1 * iastModule.taintObject(iastCtx, 'value', SourceTypes.REQUEST_HEADER_VALUE, 'header')
    0 * _
  ...
  void 'test getHeaders'() {
    ...
    headers.each { 1 * iastModule.taintObject(iastCtx, it, SourceTypes.REQUEST_HEADER_VALUE, 'headers') }
    0 * _
  ...
  void 'test getHeaderNames'() {
    ...
    headers.each { 1 * iastModule.taintObject(iastCtx, it, SourceTypes.REQUEST_HEADER_NAME, it) }
    0 * _
  ...
  void 'test getParameter'() {
    ...
    1 * iastModule.taintObject(iastCtx, 'value', SourceTypes.REQUEST_PARAMETER_VALUE, 'parameter')
    0 * _
  ...
  void 'test getParameterValues'() {
    ...
    values.each { 1 * iastModule.taintObject(iastCtx, it, SourceTypes.REQUEST_PARAMETER_VALUE, 'parameter') }
    0 * _
  ...
  void 'test getParameterMap'() {
    ...
    parameters.each { key, values ->
      1 * iastModule.taintObject(iastCtx, key, SourceTypes.REQUEST_PARAMETER_NAME, key)
      values.each { value ->
  ...
  void 'test getParameterNames'() {
    ...
    parameters.each { 1 * iastModule.taintObject(iastCtx, it, SourceTypes.REQUEST_PARAMETER_NAME, it) }
    0 * _
  ...
  void 'test get query string'() {
    ...
    1 * iastModule.taintObject(iastCtx, queryString, SourceTypes.REQUEST_QUERY)
    0 * _
  ...
  void 'test getRequestURI'() {
    ...
    1 * iastModule.taintObject(iastCtx, uri, SourceTypes.REQUEST_PATH)
    0 * _
  ...
  void 'test getPathInfo'() {
    ...
    1 * iastModule.taintObject(iastCtx, pathInfo, SourceTypes.REQUEST_PATH)
    0 * _
  ...
  void 'test getPathTranslated'() {
    ...
    1 * iastModule.taintObject(iastCtx, pathTranslated, SourceTypes.REQUEST_PATH)
    0 * _
