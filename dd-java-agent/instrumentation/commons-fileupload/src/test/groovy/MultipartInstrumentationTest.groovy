...
class MultipartInstrumentationTest extends AgentTestRunner {
  ...
  void 'test commons fileupload2 ParameterParser.parse'() {
    ...
    then:
    1 * module.taintObject(iastCtx, 'file', SourceTypes.REQUEST_MULTIPART_PARAMETER, 'name')
    1 * module.taintObject(iastCtx, _, SourceTypes.REQUEST_MULTIPART_PARAMETER, 'filename')
    0 * _
