    ...
    if (value != null) {
      ...
      if (module != null) {
        try {
          ...
          if (ctx != null) {
            module.taintObjectIfTainted(ctx, result, value);
          }
    ...
    if (args != null && args.length > 0) {
      ...
      if (module != null) {
        try {
          final IastContext ctx = IastContext.Provider.get();
          if (ctx != null) {
            module.taintObjectIfAnyTainted(ctx, result, args);
          }
        } catch (final Throwable e) {
  ...
  public static String afterToString(
    ...
    if (result != null && module != null) {
      try {
        final IastContext ctx = IastContext.Provider.get();
        if (ctx != null) {
          module.taintStringIfTainted(ctx, result, url);
        }
      } catch (final Throwable e) {
  ...
  public static URI afterNormalize(
    ...
    if (result != null && module != null) {
      try {
        final IastContext ctx = IastContext.Provider.get();
        if (ctx != null) {
          module.taintObjectIfTainted(ctx, result, url);
        }
      } catch (final Throwable e) {
        module.onUnexpectedException("After toString threw", e);
      }
