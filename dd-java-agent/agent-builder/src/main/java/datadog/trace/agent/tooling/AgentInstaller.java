...
public class AgentInstaller {
  ...
  public static ClassFileTransformer installBytebuddyAgent(
    ...
    if (InstrumenterConfig.get().isLegacyInstallerEnabled()) {
      transformerBuilder = new LegacyTransformerBuilder(agentBuilder, instrumenterIndex);
    } else {
      transformerBuilder = new CombiningTransformerBuilder(agentBuilder, instrumenterIndex);
    }
